...
import PartnerImage2 from '../../../public/Logo_BUMN_Untuk_Indonesia_2020.svg'
import PartnerImage3 from '../../../public/Logo_BUMN_Untuk_Indonesia_2020.svg'
...
const CarouselPartner = () => {
  return (
    <Carousel transitionTime={0.5} showThumbs={false} autoPlay={true} infiniteLoop={true} showStatus={false} stopOnHover={true} swipeable={true}>
    <div>
        <Image src={PartnerImage1} alt={''} />
