    ...
    <div>
     ...
     <section className='pt-20 pb-2 flex flex-col items-center justify-items-center justify-center'>
      <div className='text-center mx-44'>
        ...
        <div className="relative h-[400px]" style={{ backgroundImage: `url('/IMG_5671.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
        <article data-aos='fade-up' className='text-justify pt-10'><span className='font-bold pt-4'>PT. Fresh Beton Indonesia</span> adalah perusahaan yang bergerak di bidang beton siap pakai 
